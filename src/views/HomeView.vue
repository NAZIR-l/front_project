<template>
  ...
  <div class="page-container">
    ...
    <div class="home">
      <main class="main-content">
        <div id="mainContent" >
          <main class="main-content bgc-grey-100" style="position: relative;top: -10vh;">
                <div id="mainContent">
                                        ...
                                        <div class="peers ai-c jc-sb fxw-nw">
                                            ...
                                            <div class="peer">
                                                <div class="layers ai-fe">
                                                    ...
                                                    <div class="layer"><span class="fw-600 c-grey-600">Nov, 01
                                                            2017</span></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="layers bdB">
                                            ...
                                            <div class="layer w-100 bdT pY-5">
                                                <div class="peers ai-c jc-sb fxw-nw">
                                                    ...
                                                    <div class="peer ta-r"><span class="fw-600 c-grey-800">05:00
                                                            AM</span></div>
                                                </div>
                                            </div>
                                            <div class="layer w-100 bdT pY-5">
                                        ...
                                        <div class="peers peers-greed ai-fs ta-c">
                                            <div class="peer">
                                                <h6 class="mB-10">MON</h6><canvas class="sleet" width="30"
                                                    height="30"></canvas><span class="d-b fw-600">32<sup>°F</sup></span>
                                            </div>
                                            <div class="peer">
                                                <h6 class="mB-10">TUE</h6><canvas class="clear-day" width="30"
                                                    height="30"></canvas><span class="d-b fw-600">30<sup>°F</sup></span>
                                            </div>
                                            <div class="peer">
                                            ...
                                            <div class="peer">
                                                <h6 class="mB-10">FRI</h6><canvas class="snow" width="30"
                                                    height="30"></canvas><span class="d-b fw-600">24<sup>°F</sup></span>
                                            </div>
                                            <div class="peer">
  ...
  <script>
    ...
    import Chart_Area from '../components/manageCenter/chart/Chart_Area'
    import Chart_Line from '../components/manageCenter/chart/Cart_Line';
    import List_Vechile from '../components/manageCenter/List_Vechile.vue'
    import Map_Vechile from '../components/manageCenter/Map_Vechile.vue'
    import Add_Shipment from '../components/manageCenter/Shipment/Add_Shipment'
    import List_Shipment from '../components/manageCenter/Shipment/List_Shipment'
    import Add_Plan from '../components/manageCenter/ManageShipment/Add_Plan.vue'
    import List_Plan from '../components/manageCenter/ManageShipment/List_Plan.vue'
...
@import url('../../public/icons/themify-icons.css');
</style>
